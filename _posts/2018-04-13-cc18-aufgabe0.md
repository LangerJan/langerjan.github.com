...
Anbei auch [eine Beispiel-Eingabe auf Kursniveau]({{ site.url }}/assets/cc18/blatt0/exampleinput.txt), sowie die [erwartete Ausgabe](({{ site.url }}/assets/cc18/blatt0/exampleoutput.txt)).
