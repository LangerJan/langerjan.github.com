...
* Der Zielpunkt darf nur betreten werden, wenn der 
  Schlüsselwert mit der Zahl auf dem Tresor übereinstimmt. 
* Der **Startpunkt** ist **immer oben links**
* Der **Schatz** befindet sich **immer unten rechts**
...
* Die Schritte *SS* brachten das Papier dazu, dem Startwert 22 die Zahl 4 zu addieren -> 26.
* Die Schritte *ON* brachten das Papier dazu, den aktuellen Wert 26 mit 4 zu multiplizieren -> 104
* Die Schritte *OS* brachten das Papier dazu, den aktuellen Wert 104 um 11 zu subtrahieren -> 93
