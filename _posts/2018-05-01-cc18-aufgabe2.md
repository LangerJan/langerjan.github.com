...
* Der **Startraum** ist immer **oben links** (Nordosten)
* Der **Schatzraum** befindet sich **unten rechts** (Südwesten)
...
* Lösung der Problems in einem Projektordner in Ihrem GitLab-Projekt
  ...
  * Ihr Programm darf **nur Ihre Lösung ausgeben**. Die Lösung muss in der Form den mitgelieferten 
